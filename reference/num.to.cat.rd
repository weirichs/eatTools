<!DOCTYPE html>
<!-- Generated by pkgdown: do not edit by hand --><html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><title>Transform continuous variables into ordered factors — num.to.cat • eatTools</title><script src="../deps/jquery-3.6.0/jquery-3.6.0.min.js"></script><meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><link href="../deps/bootstrap-5.3.1/bootstrap.min.css" rel="stylesheet"><script src="../deps/bootstrap-5.3.1/bootstrap.bundle.min.js"></script><link href="../deps/font-awesome-6.4.2/css/all.min.css" rel="stylesheet"><link href="../deps/font-awesome-6.4.2/css/v4-shims.min.css" rel="stylesheet"><script src="../deps/headroom-0.11.0/headroom.min.js"></script><script src="../deps/headroom-0.11.0/jQuery.headroom.min.js"></script><script src="../deps/bootstrap-toc-1.0.1/bootstrap-toc.min.js"></script><script src="../deps/clipboard.js-2.0.11/clipboard.min.js"></script><script src="../deps/search-1.0.0/autocomplete.jquery.min.js"></script><script src="../deps/search-1.0.0/fuse.min.js"></script><script src="../deps/search-1.0.0/mark.min.js"></script><!-- pkgdown --><script src="../pkgdown.js"></script><meta property="og:title" content="Transform continuous variables into ordered factors — num.to.cat"><meta name="description" content="Function is useful if parameters on the `PISA' metric should be transformed into competence levels."><meta property="og:description" content="Function is useful if parameters on the `PISA' metric should be transformed into competence levels."></head><body>
...
<div class="row">
  <main id="main" class="col-md-9"><div class="page-header">
      ...
      <h1>Transform continuous variables into ordered factors</h1>

      <div class="d-none name"><code>num.to.cat.rd</code></div>
    </div>

    <div class="ref-description section level2">
    <p>Function is useful if parameters on the `PISA' metric should be transformed into competence levels.</p>
    </div>

    <div class="section level2">
    <h2 id="ref-usage">Usage<a class="anchor" aria-label="anchor" href="#ref-usage"></a></h2>
    <div class="sourceCode"><pre class="sourceCode r"><code><span><span class="fu">num.to.cat</span><span class="op">(</span><span class="va">x</span>, <span class="va">cut.points</span>, cat.values <span class="op">=</span> <span class="cn">NULL</span><span class="op">)</span></span></code></pre></div>
    </div>
...
Numeric vector.</p></dd>
  ...
  <dt id="arg-cut-points">cut.points<a class="anchor" aria-label="anchor" href="#arg-cut-points"></a></dt>
<dd><p><!-- %%     ~~Describe \code{file} here~~ -->
Numeric vector with cut scores.</p></dd>

  <dt id="arg-cat-values">cat.values<a class="anchor" aria-label="anchor" href="#arg-cat-values"></a></dt>
<dd><p><!-- %%     ~~Describe \code{file} here~~ -->
Optional: vector with labels for the cut scores. Note: if specified, length of
cat.values should be length(cut.points)+1.</p></dd>

</dl></div>
    <div class="section level2">
    <h2 id="value">Value<a class="anchor" aria-label="anchor" href="#value"></a></h2>
    <p>Vector with factor values.</p>
    </div>
    <div class="section level2">
...
<span class="r-out co"><span class="r-pr">#&gt;</span>  [1] 1 3 1 3 4 5 1 2 2 2</span>
...
<span class="r-out co"><span class="r-pr">#&gt;</span>  [1] "1a" "2"  "1a" "2"  "3"  "4"  "1a" "1b" "1b" "1b"</span>
<span class="r-out co"><span class="r-pr">#&gt;</span> attr(,"cat.values")</span>
