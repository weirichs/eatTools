...
This function easily transform data into the long format required by eatRep."></head><body>
...
<div class="row">
  <main id="main" class="col-md-9"><div class="page-header">
      ...
      <h1>Transform wide format data sets into the long format necessary for eatRep analyses</h1>
